...
namespace HRM.Repositories.Base
{
    public class BaseRepository<T> : IBaseRepository<T>
        where T : class
    {
        protected readonly SmartlightDbContext _context;
        protected readonly DbSet<T> _dbSet;

		SmartlightDbContext IBaseRepository<T>.Context => _context;

        public BaseRepository(SmartlightDbContext context)
        {
            _context = context;
